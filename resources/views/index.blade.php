            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="/storage/uploads/posts/{{ $first_post->featured }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="/storage/uploads/posts/{{ $first_post->featured }}" class="link-image js-zoom-image">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{ route('category.post',['id'=>$first_post->category->id]) }}">{{$first_post->category->name}}</a>
                                        </span>
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="/storage/uploads/posts/{{$second_post->featured}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="/storage/uploads/posts/{{$second_post->featured}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="/storage/uploads/posts/{{$third_post->featured}}" alt="seo">
                            <div class="/storage/uploads/posts/{{$third_post->featured}}"></div>
        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach ($first_category->posts->take(3) as $post)
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                          @foreach ($second_category->posts->take(3) as $post)
                              <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                                  <div class="case-item">
                                      <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
                                          <img src="/storage/uploads/posts/{{$post->featured}}" alt="our case">
